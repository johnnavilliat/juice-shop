...
const privateKeyTwo = '-----BEGIN RSA PRIVATE KEY-----\r\\r\n-----END RSA PRIVATE KEY-----'
...
exports.deluxeTokenTwo = (email) => {
  const hmac = crypto.createHmac('sha256', privateKeyTwo)
  return hmac.update(email + this.roles.deluxe).digest('hex')
}

exports.deluxeTokenThree = (email) => {
  const hmac = crypto.createHmac('sha256', privateKeyThree)
  return hmac.update(email + this.roles.deluxe).digest('hex')
}
